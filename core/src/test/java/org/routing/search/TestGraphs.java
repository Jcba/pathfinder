...
public class TestGraphs {
    ...
    public static Graph createConnectedGraphWithDepth3(Node start, Node destination) {
        ...
        Node node1 = new Node(0, new GJPoint(1.0f, 1.0f));
        Node node2 = new Node(1, new GJPoint(1.0f, 2.0f));
        Node node3 = new Node(2, new GJPoint(1.0f, 3.0f));
        Node node4 = new Node(3, new GJPoint(2.0f, 3.0f));
        Node node5 = new Node(4, new GJPoint(2.0f, 4.0f));
